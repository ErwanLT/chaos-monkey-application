...
public class DataLoader implements CommandLineRunner {
    ...
    private List<Video> loadVideos() {
        ...
        videos.add(videoRepository
                .save(new Video("Velocity", "Course-poursuite à grande vitesse à travers les continents", "Action", 2022, 118,
        ...
        videos.add(videoRepository
                .save(new Video("Rogue Agent", "Un espion disparaît des radars", "Action", 2023, 128, 7.9,
                        "/thumbnails/rogue-agent.png", null,
                        "Guy Tare, Henri Cochet, Bella Maman", Video.VideoType.MOVIE)));

        // Sci-Fi Movies
        videos.add(videoRepository.save(new Video("Quantum Horizon", "Des scientifiques découvrent des univers parallèles",
                "Sci-Fi",
                2023, 156, 9.1, "/thumbnails/quantum-horizon.png", null,
                "Marc Assin, Anne Onyme, Ella Bora", Video.VideoType.MOVIE)));
        videos.add(videoRepository.save(new Video("Nebula Station", "La vie sur une station spatiale lointaine", "Sci-Fi",
                2022,
        ...
        videos.add(videoRepository
                .save(new Video("The Last Colony", "Le dernier avant-poste de l'humanité", "Sci-Fi", 2020, 148,
                        8.4, "/thumbnails/last-colony.png", null,
                        "Matt Rakette, Jessie Kalamar, Jeff Ouille", Video.VideoType.MOVIE)));
        videos.add(videoRepository.save(new Video("Chronos Effect", "Thriller sur le paradoxe du voyage dans le temps", "Sci-Fi",
                2023, 139,
        ...
        // Drama Movies
        videos.add(videoRepository
                .save(new Video("Echoes of Silence", "Le voyage d'un musicien vers la rédemption", "Drama",
        ...
        videos.add(videoRepository
                .save(new Video("Whispers in the Wind", "Histoire d'amour à travers les générations", "Drama",
        ...
        videos.add(videoRepository
                .save(new Video("Wedding Crashers 2.0", "Catastrophes de mariage à l'ère numérique", "Comedy",
                        2023, 102, 7.2, "/thumbnails/wedding-crashers.png", null,
                        "Vincent Vaugn, Owen Wilson, Isla Fisher", Video.VideoType.MOVIE)));

        // Thriller Movies
        videos.add(videoRepository.save(new Video("The Vanishing", "Un détective traque un tueur en série", "Thriller",
                2023, 134, 8.4, "/thumbnails/vanishing.png", null, "Jean Bon, Harry Cover, Violette Lavie",
                Video.VideoType.MOVIE)));
        videos.add(videoRepository.save(new Video("Midnight Protocol", "Un hacker découvre une conspiration", "Thriller", 2022,
                126, 8.1, "/thumbnails/midnight-protocol.png", null,
                "Ramasse Malette, Christiane Laitière, Portia Double", Video.VideoType.MOVIE)));
        videos.add(videoRepository.save(new Video("Silent Witness", "Thriller psychologique en salle d'audience", "Thriller",
                2021, 119, 7.9, "/thumbnails/silent-witness.png", null, "Denise Lave, Françoise Mac, Coralie Quins",
                Video.VideoType.MOVIE)));

        // Horror Movies
        videos.add(videoRepository.save(new Video("The Haunting of Blackwood", "Horreur dans un manoir maudit", "Horror", 2023,
                108, 7.6, "/thumbnails/blackwood.png", null, "Tony Colette, Alex Loup, Millie Chapeau",
                Video.VideoType.MOVIE)));
        videos.add(videoRepository.save(new Video("Shadows Below", "La terreur souterraine se réveille", "Horror", 2022, 95,
                7.3, "/thumbnails/shadows-below.png", null, "Loupita Niongo, Winston Duc, Élisabeth Mousse",
                Video.VideoType.MOVIE)));

        // Series - Drama
        videos.add(videoRepository.save(new Video("Crown of Thorns - Season 1", "Lutte de pouvoir médiévale", "Drama",
                2023, 480, 9.2, "/thumbnails/crown-thorns.png", null, "Olive Colmant, Toby Menzy, Hélène Bonhomme",
                Video.VideoType.SERIES)));
        videos.add(videoRepository.save(new Video("Crown of Thorns - Season 2", "La guerre continue", "Drama", 2023, 480,
                9.3, "/thumbnails/crown-thorns-s2.png", null, "Olive Colmant, Josse O'Conor, Emma Corinne",
                Video.VideoType.SERIES)));
        videos.add(videoRepository.save(new Video("Silicon Valley Dreams", "Drame de startup technologique", "Drama", 2022, 400,
                8.5, "/thumbnails/silicon-valley.png", null, "Thomas Milieu, T.J. Meunier, Camille Nanjiani",
                Video.VideoType.SERIES)));
        videos.add(videoRepository.save(new Video("The Diplomat", "Intrigue politique internationale", "Drama", 2023,
                420, 8.7, "/thumbnails/diplomat.png", null, "Kévin Russell, Rufin Sewell, David Jasi",
                Video.VideoType.SERIES)));

        // Series - Sci-Fi
        videos.add(videoRepository.save(new Video("Starbound - Season 1", "Exploration interstellaire", "Sci-Fi", 2023,
                520, 9.0, "/thumbnails/starbound.png", null, "Pierre Pascal, Belle Ramée, Anne Torve",
                Video.VideoType.SERIES)));
        videos.add(videoRepository.save(new Video("Starbound - Season 2", "Nouveaux mondes découverts", "Sci-Fi", 2023, 520,
                9.1, "/thumbnails/starbound-s2.png", null, "Pierre Pascal, Belle Ramée, Nicolas Offre",
                Video.VideoType.SERIES)));
        videos.add(videoRepository.save(new Video("The Expanse: Aftermath", "Opéra spatial post-guerre", "Sci-Fi", 2022, 450,
                8.9, "/thumbnails/expanse-aftermath.png", null, "Étienne Droit, Dominique Tipée, Wesley Chatam",
                Video.VideoType.SERIES)));
        videos.add(videoRepository.save(new Video("Cyberpunk Chronicles", "Futur dystopique noir", "Sci-Fi", 2023, 380,
                8.6, "/thumbnails/cyberpunk.png", null, "Kévin Rêve, Carrie-Anne Mousse, Laurent Poisson",
                Video.VideoType.SERIES)));

        // Series - Crime
        videos.add(videoRepository.save(new Video("Detective Noir", "Histoires de détectives à l'ancienne", "Crime", 2023, 360,
                8.4, "/thumbnails/detective-noir.png", null, "Bryan Cranston, Aaron Paul, Anna Gunn",
                Video.VideoType.SERIES)));
        videos.add(videoRepository.save(new Video("The Cartel", "Ascension et chute d'un empire de la drogue", "Crime", 2022, 480, 8.8,
                "/thumbnails/cartel.png", null, "Wagner Moura, Boyd Holbrook, Pedro Pascal", Video.VideoType.SERIES)));
        videos.add(videoRepository.save(new Video("White Collar Crimes", "Enquête sur la fraude financière", "Crime", 2023,
                340, 8.2, "/thumbnails/white-collar.png", null, "Matt Bomer, Tim DeKay, Willie Garson",
                Video.VideoType.SERIES)));

        // Series - Comedy
        videos.add(videoRepository.save(new Video("The IT Crowd Reboot", "Comédie de support technique", "Comedy", 2023, 240,
                8.1, "/thumbnails/it-crowd.png", null, "Chris ODowd, Richard Ayoade, Katherine Parkinson",
                Video.VideoType.SERIES)));
        videos.add(videoRepository.save(new Video("Apartment 42", "Mésaventures de colocataires", "Comedy", 2022, 220, 7.9,
                "/thumbnails/apartment-42.png", null, "Kaley Cuoco, Jim Parsons, Johnny Galecki",
                Video.VideoType.SERIES)));

        // Documentaries
        videos.add(videoRepository.save(new Video("Planet Earth: The Future", "Documentaire sur le changement climatique",
                "Documentary", 2023, 180, 9.4, "/thumbnails/planet-earth.png", null, "David Attenborough",
                Video.VideoType.DOCUMENTARY)));
        videos.add(videoRepository.save(new Video("The AI Revolution", "L'impact de l'intelligence artificielle",
        ...
        videos.add(videoRepository.save(new Video("Ocean Depths", "Exploration des grands fonds marins", "Documentary", 2022, 120, 9.0,
        ...
        videos.add(videoRepository.save(new Video("Ancient Civilizations", "Villes perdues découvertes",
                ...
                Video.VideoType.DOCUMENTARY)));
        videos.add(videoRepository.save(new Video("The Space Race 2.0", "Exploration spatiale moderne", "Documentary", 2023,
                110, 8.8, "/thumbnails/space-race.png", null, "Neil deGrasse Tyson", Video.VideoType.DOCUMENTARY)));
        videos.add(videoRepository.save(new Video("Wildlife Warriors", "Héros de la conservation", "Documentary",
                2022, 85, 8.5, "/thumbnails/wildlife-warriors.png", null, "Steve Irwin Family",
                Video.VideoType.DOCUMENTARY)));
        videos.add(videoRepository.save(new Video("The Crypto Phenomenon", "La révolution de la blockchain", "Documentary", 2023,
                102, 8.3, "/thumbnails/crypto.png", null, "Vitalik Buterin", Video.VideoType.DOCUMENTARY)));
        videos.add(videoRepository.save(new Video("Mind Matters", "Avancées en neurosciences", "Documentary", 2023, 95,
                8.6, "/thumbnails/mind-matters.png", null, "Andrew Huberman", Video.VideoType.DOCUMENTARY)));

        // Romance
        videos.add(videoRepository.save(new Video("Love in Paris", "Comédie romantique en France", "Romance", 2023, 108,
                7.8, "/thumbnails/love-paris.png", null, "Lily Collins, Lucas Bravo, Camille Razat",
                Video.VideoType.MOVIE)));
        videos.add(videoRepository.save(new Video("Second Chances", "Trouver l'amour après la perte", "Romance", 2022, 115,
                8.0, "/thumbnails/second-chances.png", null, "Julia Roberts, George Clooney", Video.VideoType.MOVIE)));
        videos.add(videoRepository.save(new Video("The Letter", "Histoire d'amour à distance", "Romance", 2023, 102, 7.6,
                "/thumbnails/letter.png", null, "Amanda Seyfried, Channing Tatum", Video.VideoType.MOVIE)));

        // Fantasy
        videos.add(videoRepository.save(new Video("Realm of Dragons", "Aventure fantastique épique", "Fantasy", 2023, 165,
                8.9, "/thumbnails/realm-dragons.png", null, "Emilia Clarke, Kit Harington, Peter Dinklage",
                Video.VideoType.MOVIE)));
        videos.add(videoRepository.save(new Video("The Sorcerer's Apprentice Returns", "Aventures dans une école de magie",
                "Fantasy", 2022, 138, 8.2, "/thumbnails/sorcerer.png", null,
                "Daniel Radcliffe, Emma Watson, Rupert Grint", Video.VideoType.MOVIE)));
        videos.add(videoRepository.save(new Video("Legends of Avalon", "La légende arthurienne réinventée", "Fantasy", 2023,
